...
class _WishListState extends State<WishList> {
  ...
  static List<WishList_model> list_wishList = [
    WishList_model('assets/w_1.png','ALEX','Unit laci, abu-abu toska, \n 36x70 cm','Rp1.350.000'),
    WishList_model('assets/w_2.png', 'MILLBERGET', 'Kursi putar, murum hitam', 'Rp1.799.000'),
    WishList_model('assets/w_3.png', 'SONGESAND', 'Rngk tmpt tdr dg 2 ktk penyimpanan,  cokelat, 160x200 cm', 'Rp3.499.000'),
    WishList_model('assets/w_4.png', 'HEKTAR', 'Lampu lantai, abu-abu tua', 'Rp1.299.000'),
  ];
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => ListTile(
                  ...
                  trailing: Icon(Icons.more_vert,color: Color(0xff1B1B1B),),
